...
const WishList = () => {
  ...
  const data = currentUserData?.data?.wishlist || undefined;
  // const {title,author,genre,image,publication_date}= currentUserData?.data?.wishlist || undefined
  return (
    <div>
      <div className=" mx-auto md:px-[100px] my-20 pt-10 text-green-500">
        <h1 className="text-center text-3xl font-bold pb-2">My WishList</h1>
        <div>
